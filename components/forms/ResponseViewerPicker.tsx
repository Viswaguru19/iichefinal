...
/** Pick extra portal members who may view this form’s responses (besides admin/faculty/creator). */
export default function ResponseViewerPicker({ selectedIds, onChange }: Props) {
    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-0.5">
          Always: admins &amp; faculty (and the form creator). Add specific members below. Other IIChE members cannot open responses.
        </p>
      </div>
